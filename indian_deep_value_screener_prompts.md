...
and a value score out of 10. Sort by value score descending.
```
...
promoter holding > 40%, pledged shares < 10%, 5-year sales CAGR > 8%, 
and positive free cash flow. Include small, mid and large caps across 
diverse sectors. For each stock provide: name, ticker, sector, P/E, P/B, 
